    ...
    <form onSubmit={handleSearch} className={`relative ${className}`}>
      <div className="relative">
        <Textarea
          ...
          className={`${paddingClasses[size]} ${sizeClasses[size]} ${fontClasses[size]} rounded-3xl border-2 border-gray-200 hover:border-gray-300 focus:border-black transition-all duration-300 placeholder:font-normal placeholder:text-base resize-none bg-white`}
          rows={2}
        />
